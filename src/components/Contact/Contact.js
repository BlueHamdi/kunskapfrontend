  ...
  return (
    <div className="contact-info-container">
      ...
      <div className="contact-details">
        ...
        <p className="contact-help-text">For help, please email us at <a href="mailto:kunskapsvarvet@help.com" className="contact-info-support-link">kunskapsvarvet@help.com</a></p>
      </div>
    </div>
  );
};
